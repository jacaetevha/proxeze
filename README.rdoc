...
in addition to the object, the arguments passed to the method, the method called, and a result (which is populated for #after and 
#after_all hooks). You need to define a #call method. Proxeze will create a new instance of the class every time it needs to use it.
